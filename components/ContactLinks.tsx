  ...
  return (
    <section className="py-10 sm:py-14">
      <div className="section-shell space-y-6">
        {showCtaBanner ? (
          <section className="overflow-hidden rounded-[2rem] border border-brand-100 bg-[linear-gradient(180deg,_rgba(255,255,255,0.98),_rgba(238,242,247,0.94)),repeating-linear-gradient(-78deg,rgba(1,31,75,0.05)_0px,rgba(1,31,75,0.05)_1px,transparent_1px,transparent_22px)] px-6 py-10 text-center shadow-[0_25px_70px_-30px_rgba(1,31,75,0.16)] dark:border-white/10 dark:bg-[linear-gradient(180deg,_rgba(1,31,75,0.94),_rgba(1,15,38,0.92)),repeating-linear-gradient(-78deg,rgba(255,255,255,0.04)_0px,rgba(255,255,255,0.04)_1px,transparent_1px,transparent_22px)] sm:px-10 sm:py-11">
        ...
        {showContactCard ? (
          aboutMode ? (
            <section className="overflow-hidden rounded-[2rem] border border-accent-500/15 bg-[radial-gradient(circle_at_top,_rgba(0,195,255,0.08),_transparent_28%),linear-gradient(180deg,_rgba(255,255,255,0.98),_rgba(238,242,247,0.96))] px-6 py-14 text-center shadow-[0_28px_70px_-35px_rgba(1,31,75,0.18)] dark:border-white/10 dark:bg-[radial-gradient(circle_at_top,_rgba(0,195,255,0.1),_transparent_28%),linear-gradient(180deg,_rgba(1,31,75,0.98),_rgba(1,15,38,0.98))] dark:shadow-[0_28px_70px_-35px_rgba(0,0,0,0.45)] sm:px-10">
              ...
              <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                ...
                <div className="grid auto-rows-fr gap-4 sm:grid-cols-3">
                  <div className="flex h-full min-h-[112px] flex-col justify-center rounded-3xl border border-brand-100 bg-white/75 px-5 py-4 dark:border-white/10 dark:bg-brand-900/60">
                    <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-accent-500 text-brand-900 shadow-accent dark:bg-accent-400 dark:text-slate-950">
