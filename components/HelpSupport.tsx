      ...
      <div className="section-shell">
        <Reveal className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-md text-base leading-7 text-accent-600 dark:text-accent-300">
              Talk to us via livechat Send us via WhatsApp Leave a ticket Call us where ever you are.
            </p>

            <Link href="/contact" className="button-primary mt-7 inline-flex">
              Contact Us
            </Link>
          </div>

          <div className="relative mx-auto h-52 w-full max-w-sm overflow-hidden rounded-[20px] sm:h-64">
            <Image
