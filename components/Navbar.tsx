            ...
            <div className="flex items-center gap-3 lg:hidden">
              ...
              <button
                ...
                className={`inline-flex h-11 w-11 items-center justify-center rounded-full border shadow-sm transition ${
                  forceDark
                    ? "border-white/10 bg-brand-900 text-slate-200 hover:border-accent-500/60 hover:text-accent-300"
                    : "border-brand-100 bg-white text-slate-700 hover:border-accent-300 hover:text-brand-800 dark:border-slate-700 dark:bg-brand-900 dark:text-slate-200 dark:hover:border-accent-500/60 dark:hover:text-accent-300"
                }`}
            ...
            <div className="pb-4 lg:hidden">
              <div className={`space-y-2 rounded-3xl border p-4 backdrop-blur ${
                forceDark
                  ...
                  : "card-surface dark:bg-brand-900/95"
              }`}>
                {navItems.map((item) => {
                  const isActive = pathname === item.href;
